  ...
  module BuilderMixin
    ...
    def link_to_add(*args, &block)
      ...
      @template.after_nested_form(association) do
        ...
        "<script>window['#{association}_fields_blueprint']=\"#{@template.escape_javascript(fields_for(association, model_object, :child_index => "new_#{association}", :builder => @nested_builder, &@fields[association]))}\";</script>"
      end
